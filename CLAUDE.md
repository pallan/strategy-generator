...
A curling strategy practice tool that generates randomized in-game scenarios using SVG rendering. Players/teams use it to discuss strategy for different game situations.
